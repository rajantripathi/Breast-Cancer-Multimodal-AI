        ...
        rows.append(
            {
                ...
                "vital_status": _first_non_empty(demographic.get("vital_status"), diagnosis.get("vital_status")),
                "days_to_death": _first_non_empty(demographic.get("days_to_death"), diagnosis.get("days_to_death")),
