...
This project can be connected to DialogXR as a multimodal healthcare AI capability, but the right framing is important.

## Recommended Framing

DialogXR should not be described as simply "using the model." A stronger company-level story is:
