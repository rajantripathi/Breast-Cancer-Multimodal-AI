#!/bin/bash
# VinDr-only ablation: keep weighted BCE but remove the balanced sampler.

#SBATCH --job-name=bcai-mammo-wonly
...
#SBATCH --output=logs/mammo_wonly_%j.out
...
OUTPUT_DIR="${OUTPUT_DIR:-outputs/mammography/vindr_weighted_only_seed42}"
