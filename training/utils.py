...
def build_parser(task_name: str) -> argparse.ArgumentParser:
    ...
    parser.add_argument("--vision-aggregation", choices=["abmil", "mean", "transmil"], default="mean")
    parser.add_argument("--genomics-aggregation", choices=["flat", "pathway_tokens"], default="flat")
    parser.add_argument("--clinical-aggregation", choices=["embedded", "flat"], default="flat")
    parser.add_argument("--max-vision-instances", type=int, default=256)
    parser.add_argument("--cv-folds", type=int, default=5, help="Compatibility flag; TCGA trainers currently run 5-fold CV")
